...
int Normalization_13TeV::Init(int sqrtS){
    ...
    for (double mH=120;mH<130.05;mH+=0.1){ // breaks when extended beyond 130
        ...
        */
        ...
        //Stage 1.1
        XSectionMap_GG2H_PTH_GT200[mH] = 0.9189 * 0.0212 * valXSggH;
        XSectionMap_GG2H_0J_PTH_0_10[mH] = 0.9189 * 0.1290 * valXSggH;
        XSectionMap_GG2H_0J_PTH_GT10[mH] = 0.9189 * 0.3867 * valXSggH;
        XSectionMap_GG2H_1J_PTH_0_60[mH] = 0.9189 * 0.1472 * valXSggH;
        XSectionMap_GG2H_1J_PTH_60_120[mH] = 0.9189 * 0.1025 * valXSggH;
        XSectionMap_GG2H_1J_PTH_120_200[mH] = 0.9189 * 0.0205 * valXSggH;
        XSectionMap_GG2H_GE2J_MJJ_0_350_PTH_0_60[mH] = 0.9189 * 0.0266 * valXSggH;
        XSectionMap_GG2H_GE2J_MJJ_0_350_PTH_60_120[mH] = 0.9189 * 0.0403 * valXSggH;
        XSectionMap_GG2H_GE2J_MJJ_0_350_PTH_120_200[mH] = 0.9189 * 0.0233 * valXSggH;
        XSectionMap_GG2H_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_0_25[mH] = 0.9189 * 0.0067 * valXSggH;
        XSectionMap_GG2H_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_GT25[mH] = 0.9189 * 0.0093 * valXSggH;
        XSectionMap_GG2H_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_0_25[mH] = 0.9189 * 0.0030 * valXSggH;
        XSectionMap_GG2H_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_GT25[mH] = 0.9189 * 0.0035 * valXSggH;       

        XSectionMap_VBF_0J[mH] = 0.9297 * 0.0653 * valXSqqH;
        XSectionMap_VBF_1J[mH] = 0.9297 * 0.3276 * valXSqqH;
        XSectionMap_VBF_GE2J_MJJ_0_60[mH] = 0.9297 * 0.0103 * valXSqqH;
        XSectionMap_VBF_GE2J_MJJ_60_120[mH] = 0.9297 * 0.0183 * valXSqqH;
        XSectionMap_VBF_GE2J_MJJ_120_350[mH] = 0.9297 * 0.1103 * valXSqqH;
        XSectionMap_VBF_GE2J_MJJ_GT350_PTH_GT200[mH] = 0.9297 * 0.0412 * valXSqqH;
        XSectionMap_VBF_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_0_25[mH] = 0.9297 * 0.1201 * valXSqqH;
        XSectionMap_VBF_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_GT25[mH] = 0.9297 * 0.0245 * valXSqqH;
        XSectionMap_VBF_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_0_25[mH] = 0.9297 * 0.1671 * valXSqqH;
        XSectionMap_VBF_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_GT25[mH] = 0.9297 * 0.0450 * valXSqqH;

        XSectionMap_WH2HQQ_0J[mH] = 0.8857 * 0.0433 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_1J[mH] = 0.8857 * 0.2905 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_GE2J_MJJ_0_60[mH] = 0.8857 * 0.0317 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_GE2J_MJJ_60_120[mH] = 0.8857 * 0.3360 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_GE2J_MJJ_120_350[mH] = 0.8857 * 0.14653 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_GE2J_MJJ_GT350_PTH_GT200[mH] = 0.8857 * 0.0083 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_0_25[mH] = 0.8857 * 0.0041 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_GT25[mH] = 0.8857 * 0.0202 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_0_25[mH] = 0.8857 * 0.0009 * valXSWH2HQQ;
        XSectionMap_WH2HQQ_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_GT25[mH] = 0.8857 * 0.0045 * valXSWH2HQQ;

        XSectionMap_ZH2HQQ_0J[mH] = 0.8857 * 0.0433 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_1J[mH] = 0.8857 * 0.2905 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_GE2J_MJJ_0_60[mH] = 0.8857 * 0.0317 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_GE2J_MJJ_60_120[mH] = 0.8857 * 0.3360 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_GE2J_MJJ_120_350[mH] = 0.8857 * 0.14653 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_GE2J_MJJ_GT350_PTH_GT200[mH] = 0.8857 * 0.0083 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_0_25[mH] = 0.8857 * 0.0041 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_GT25[mH] = 0.8857 * 0.0202 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_0_25[mH] = 0.8857 * 0.0009 * valXSZH2HQQ;
        XSectionMap_ZH2HQQ_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_GT25[mH] = 0.8857 * 0.0045 * valXSZH2HQQ;

        XSectionMap_QQ2HLNU_PTV_0_75[mH] = 0.8869 * 0.5 * valXSQQ2HLNU;
        XSectionMap_QQ2HLNU_PTV_75_150[mH] = 0.8869 * 0.4467 * valXSQQ2HLNU;
        XSectionMap_QQ2HLNU_PTV_150_250_0J[mH] = 0.8869 * 0.0203 * valXSQQ2HLNU;
        XSectionMap_QQ2HLNU_PTV_150_250_GE1J[mH] = 0.8869 * 0.0260 * valXSQQ2HLNU;
        XSectionMap_QQ2HLNU_PTV_GT250[mH] = 0.8869 * 0.0070 * valXSQQ2HLNU;

        XSectionMap_QQ2HLL_PTV_0_75[mH] = 0.8869 * 0.4558 * valXSQQ2HLL;
        XSectionMap_QQ2HLL_PTV_75_150[mH] = 0.8869 * 0.3078 * valXSQQ2HLL;
        XSectionMap_QQ2HLL_PTV_150_250_0J[mH] = 0.8869 * 0.0515 * valXSQQ2HLL;
        XSectionMap_QQ2HLL_PTV_150_250_GE1J[mH] = 0.8869 * 0.0420 * valXSQQ2HLL;
        XSectionMap_QQ2HLL_PTV_GT250[mH] = 0.8869 * 0.0297 * valXSQQ2HLL;

        XSectionMap_TTH[mH]                      = 0.9861 * valXSttH;
        XSectionMap_BBH[mH]                      = valXSbbH;
        XSectionMap_THQ[mH]                      = valXStHq;
        XSectionMap_THW[mH]                      = valXStHW;
        XSectionMap_GGZH[mH]                     = valXSggZH;
